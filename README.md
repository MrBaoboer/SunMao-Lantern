...
**慢也没关系。** 旁白按 3.3–4 字／秒配速，单行不超过约三十字；生僻词带注音（「榫卯，sǔn mǎo」「枨，chéng」）；
灯谜答错不扣分、不重来，也不用红色。
...
判定分三层：哪一条道、啃到多深、走到哪儿 —— 横枨两头那两个透眼隔着大半根料，
第一个凿穿了第二个还是实心，靠的正是第三层。工具只有锯、凿、刨三样。
...
仓库也不含音频文件，旁白与背景音乐留了挂载口；没有音频时字幕照常走完（见 [DESIGN.md](DESIGN.md#9-音频)）。
